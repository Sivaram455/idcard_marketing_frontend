    ...
    return (
        <div className="p-5 space-y-5">
            ...
            <div className="flex items-center justify-between gap-4">
                <div>
                    <h1 className="text-base font-extrabold text-gray-900 tracking-tight">Dashboard</h1>
                    <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-widest mt-0.5">
                        Acquisition & conversion overview
                    </p>
                </div>
                <button
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                <StatCard label="Pipeline" value={stats.totalLeads} icon={Users} colorClass="bg-gray-100 text-gray-600" />
            ...
            {/* ── Bottom Grid: Pipeline Health + Recent Activities ── */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col">
                    <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
                        <h2 className="text-xs font-extrabold text-gray-700 uppercase tracking-wide">Recent Activities</h2>
                                ...
                                {activities.map(act => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-bold text-gray-900 group-hover:text-indigo-700 truncate transition-colors">{act.school_name}</p>
